...
public class UINeuerNutzer extends JDialog {
	/** vielleicht sollten wir Neuer Nutzer mit dem Konstruktor von User verbindn
	 * 	Diese Klasse ist ja eher die UI um einen neuen Nutzer anzulegen weshalb es vielleicht sinnvoll ist
	 * 	UI und Logik zu trennen
	 * 
	 */
